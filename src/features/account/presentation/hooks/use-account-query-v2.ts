...
import { useAccountFormStore } from '../../application/account-store-v2';
...
export const useCreateProfileMutation = () => {
  ...
  const { setHasCompletedProfile, resetForm } = useAccountFormStore.getState();
...
export const useUploadAvatarMutation = () => {
  const { setUploadState } = useAccountFormStore.getState();
